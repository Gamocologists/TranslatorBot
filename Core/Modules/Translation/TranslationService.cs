...
public static class TranslationService
{
    ...
    /// </summary>
    /// <returns>
    ///     True if maximum number of free character translations have been used up.
    ///     False if the maximum number of free character translations have not been used up.
    /// </returns>
    ...
    private static Translator? TranslatorSetUp()
    {
        DataAssociation dataAssociation =
            DataAssociation.FromFile("../../../Modules/Translation/Data/translator_data.da");
